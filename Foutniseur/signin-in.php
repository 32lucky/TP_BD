...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT * FROM fournisseurs WHERE nom = '$username' AND Password = '$password'";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        
        $_SESSION['username'] = $username;
        header("Location:add_merchandise_form.php ");
        exit();
    } else {
        // Invalid credentials
...
<div class="form-box">
<form class="form" action="signin-in.php"  method="post">
